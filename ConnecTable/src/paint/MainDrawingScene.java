...
//        final MTSceneTexture sceneWindow = new MTSceneTexture(0,0, pa, drawingScene);
        ...
        b.setNoStroke(true);
        b.translate(new Vector3D(600,250,0));
...
//					//As we are messing with opengl here, we make sure it happens in the rendering thread
        ...
        penButton.translate(new Vector3D(600, 300,0));
        ...
        brushButton.translate(new Vector3D(600, 350,0));
...
//        final MTColorPicker colorWidget = new MTColorPicker(0, pa.height-colPick.height, colPick, pa);
        ...
        colorWidget.translate(new Vector3D(650, 350,0));
        ...
        colPickButton.translate(new Vector3D(600, 400,0));
        ...
        slider.translate(new Vector3D(600, 250));
