...
//		logger.setLevel(ILogger.DEBUG);
	...
	private void init(float x, float y, float width, float height){
		...
		final float buttonOpacity = 200;
		
		//CLOSE BUTTON
		Vector3D a = new Vector3D(25, 25);
		final MTRectangle closeButton = new MTRectangle(app, x + a.x/2f, y + a.y/2f, buttonWidth, buttonHeight);
		...
		closeButton.setSizeXYGlobal(60, 60);
		...
		if (this.windowedScene){
			...
			final MTRectangle restoreButton = new MTRectangle(app, x + b.x/2f, y + b.y/2f, buttonWidth, buttonHeight);
