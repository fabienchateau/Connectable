...
//            tp.setLockPriority(1.5f); 
	...
	private KeyInfo[] getKeysLayout(){
	    ...
	    */
	    if (l.getLanguage().equalsIgnoreCase(Locale.FRANCE.getLanguage())){
	    	return getFrenchLayout();
	    }else{
	    	return getUSLayout();
	    }
	}
	...
	private KeyInfo[] getFrenchLayout(){
...
//		keyInfos.add(new KeyInfo("^", "^", "^", new Vector3D(startX,lineY), 			  KeyInfo.NORMAL_KEY)); //ESC key
		...
		keyInfos.add(new KeyInfo("A", "a", "A", new Vector3D(startX+1*advanceMent,lineY),  KeyInfo.NORMAL_KEY)); 
		...
		lineY = 119;
		startX = 136;  //+58
		keyInfos.add(new KeyInfo("Q", "q", "Q", new Vector3D(startX,lineY), 			   KeyInfo.NORMAL_KEY)); //
		...
		keyInfos.add(new KeyInfo("M", "m", "M", new Vector3D(startX+9*advanceMent,lineY),  KeyInfo.NORMAL_KEY));
		//%
		keyInfos.add(new KeyInfo("%", "%", "%", new Vector3D(startX+9*advanceMent,lineY),  KeyInfo.NORMAL_KEY));
		//*
        keyInfos.add(new KeyInfo("*", "*", "*", new Vector3D(startX+10*advanceMent,lineY),  KeyInfo.NORMAL_KEY));
		...
		keyInfos.add(new KeyInfo(",", ",", ",", new Vector3D(startX+8*advanceMent,lineY), KeyInfo.KEY_ONLY_VISIBLE_WHEN_SHIFT_NOTPRESSED));
		keyInfos.add(new KeyInfo("?", "?", "?", new Vector3D(startX+8*advanceMent,lineY), KeyInfo.KEY_ONLY_VISIBLE_WHEN_SHIFT_PRESSED));
		...
		keyInfos.add(new KeyInfo("!", "!", "!", new Vector3D(startX+11*advanceMent,lineY), KeyInfo.KEY_ONLY_VISIBLE_WHEN_SHIFT_NOTPRESSED));
		keyInfos.add(new KeyInfo("111", "A", "A", new Vector3D(startX+11*advanceMent,lineY), KeyInfo.KEY_ONLY_VISIBLE_WHEN_SHIFT_PRESSED));
